 ...
 * 文件名称: CalPositionMarketValueOnTradable.java
 ...
 * 类名称：CalPositionMarketValueOnTradable
 * 类描述：计算持仓市值 投资标志=交易性/可供出售
 * 创建人：@author wanglei
 * 创建时间：2019/10/16/13:24
 */
@Service
public class CalPositionMarketValueOnTradable implements ICalPositionMarketValue {
    @Override
