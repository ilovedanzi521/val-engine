        ...
        if(ObjectUtil.isNotEmpty(list)){
            for (Object rt : list) {
                if(rt!=null){
                    ...
                    if(TradeRuleConstant.VAL_CRITERIA_P001.equals(tmpParam.getValCriteria()) || TradeRuleConstant.VAL_CRITERIA_P002.equals(tmpParam.getValCriteria())){
                        this.setOriginalPrice(this.getNetPrice());
                    }else if(TradeRuleConstant.VAL_CRITERIA_P003.equals(tmpParam.getValCriteria()) || TradeRuleConstant.VAL_CRITERIA_P004.equals(tmpParam.getValCriteria())
                            || TradeRuleConstant.VAL_CRITERIA_P005.equals(tmpParam.getValCriteria())){
